                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="OOP">History</SelectItem>
                        <SelectItem value="OS">Оперативни системи</SelectItem>
                        <SelectItem value="BP">History</SelectItem>
                        <SelectItem value="VP">History</SelectItem>
                        <SelectItem value="DICK">History</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormControl>
                  <FormMessage />
